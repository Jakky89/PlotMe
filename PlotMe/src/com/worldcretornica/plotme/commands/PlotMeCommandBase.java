...
public abstract class PlotMeCommandBase {
	...
	static PlotMeCommands cmdMainClass;
	
	
	public PlotMeCommandBase(PlotMeCommands cmd)
	{
		cmdMainClass = cmd;
	}
	 ...
	 * ABSTRACT METHODS
	 */
	public abstract boolean run(CommandSender sender, String[] args); // should return false when e.g. command arguments were missing
