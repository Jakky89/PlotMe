...
public class PlotRoom {
	...
	{
		return setLocations(PlotManager.getPlotWorld(loc1.getWorld().getName()), loc1.getBlockX(), loc1.getBlockY(), loc1.getBlockZ(), loc2.getBlockX(), loc2.getBlockY(), loc2.getBlockZ());
	}
	
	public boolean setLocations(Pair<Location, Location> locations)
	{
		if (!locations.getLeft().getWorld().getName().equals(locations.getRight().getWorld().getName()))
		{
			return false;
		}
